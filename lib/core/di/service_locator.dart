...
import 'package:prac5/features/books/data/repositories/books_repository_impl.dart';

final getIt = GetIt.instance;

Future<void> setupServiceLocator() async {
  getIt.registerSingleton<BooksLocalDataSource>(BooksLocalDataSource());

  getIt.registerSingleton<BooksRepository>(
    BooksRepositoryImpl(localDataSource: getIt<BooksLocalDataSource>()),
  );
...
class Repositories {
  static BooksRepository get books => getIt<BooksRepository>();
}
